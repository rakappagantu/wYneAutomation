...
public class ElementDecorator implements FieldDecorator {
    ...
    public Object decorate(ClassLoader loader, Field field) {
    	//EMMLog.entry("Internal Framework methods - decorator");
    	myfield = field;
    	...
    	if (field.isAnnotationPresent(FindBy.class)){
    		...
    		//SnapLogger.LOGGER.debug(findBy);
    		//SnapLogger.LOGGER.debug("Identifying the element:[" +field.getName()+"] of type:[" +field.getType().getSimpleName() + "],how:[" + findBy.how()+ "],using:[" +  findBy.using() + "]");
    		//SnapLogger.LOGGER.debug("Instance of :" + field.getDeclaringClass().getSimpleName());
    		pageName = field.getDeclaringClass().getSimpleName();
        ...
        if (WebElement.class.equals(fieldType)) {
            fieldType = SlWebElement.class;
            //SnapLogger.LOGGER.debug(findBy.toString());
        }

        //EMMLog.exit("Internal Framework methods - decorator");
    ...
    protected <T> T proxyForLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator) {
        InvocationHandler handler = new ElementHandler(interfaceType, myfield, locator);
        ...
        //SnapLogger.LOGGER.debug("Locator Info:" + locator.toString() + ", Element:" + interfaceType.toString() );
        return proxy;
